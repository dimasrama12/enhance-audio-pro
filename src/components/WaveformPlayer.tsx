...
export default function WaveformPlayer({ filepath, outputFilepath, filename }: Props): JSX.Element {
  ...
  // ── File-load effect: creates a NEW WaveSurfer instance AND a fresh audio pipeline per-file ──
  ...
  useEffect(() => {
    ...
    // Pause and cleanly destroy the PREVIOUS file's audio pipeline.
    // This prevents Chromium decoders from leaking when swapping files rapidly.
